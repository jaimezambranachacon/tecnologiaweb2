...
<div class="bg-white min-h-screen p-8 md:p-16 text-slate-800">
    ...
    <div class="max-w-4xl space-y-4">
        ...
        <a href="https://gsyc.urjc.es/~mortuno/programacion_web.pdf?utm_source=copilot.com" target="_blank" class="group flex items-center p-4 md:p-6 bg-slate-50 border border-slate-100 rounded-2xl hover:bg-white hover:border-orange-400 hover:shadow-xl transition-all duration-300">
            ...
            <div class="ml-6 flex-1">
                ...
                <h3 class="text-xl md:text-2xl font-black text-[#003366] group-hover:text-orange-500 transition-colors leading-tight">Programación Web: HTML, CSS, JavaScript</h3>
                <p class="text-sm text-slate-500 mt-1">Apuntes para el alumno</p>
            </div>
...
-->
        ...
        <a href="Manual de PHP" target="_blank" class="group flex items-center p-4 md:p-6 bg-orange-50/30 border-2 border-dashed border-orange-200 rounded-2xl hover:bg-white hover:border-orange-400 hover:shadow-xl transition-all duration-300">
            <div class="w-16 h-16 rounded-full bg-orange-100 flex items-center justify-center text-orange-500 group-hover:bg-orange-500 group-hover:text-white group-hover:scale-110 transition-all shadow-sm flex-shrink-0">
                <i class="fas fa-desktop text-2xl"></i>
            </div>
            <div class="ml-6 flex-1">
                <span class="text-[10px] font-black uppercase tracking-widest text-orange-500 mb-1 block">Slides en Línea</span>
                <h3 class="text-xl md:text-2xl font-black text-[#003366] group-hover:text-orange-500 transition-colors leading-tight">PHP</h3>
                <p class="text-sm text-slate-500 mt-1">Php backend</p>
            </div>
            <i class="fas fa-external-link-alt opacity-0 group-hover:opacity-100 text-orange-400 transition-opacity hidden md:block text-xl"></i>
        </a>
        </div>
